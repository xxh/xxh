...
|-----------------------------------------------------------------------|------------|-------------|---------|------|
| [prerun](https://github.com/xxh/xxh/wiki#what-is-xxh-prerun-plugin)   | stable     |             | [xxh](https://github.com/xxh/xxh-plugin-prerun-xxh), [vim](https://github.com/xxh/xxh-plugin-prerun-vim), [mc](https://github.com/xxh/xxh-plugin-prerun-mc), [docker](https://github.com/xxh/xxh-plugin-prerun-docker) | | | 
